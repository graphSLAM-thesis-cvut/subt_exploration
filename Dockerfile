...
RUN sed -i 's/spawnWorldXPos = 0/spawnWorldXPos = 18/' /home/developer/subt_ws/src/subt/subt_ign/launch/cave_circuit.ign
RUN sed -i 's/spawnWorldYPos = 0/spawnWorldYPos = -7/' /home/developer/subt_ws/src/subt/subt_ign/launch/cave_circuit.ign
