...
bool expand(const Eigen::MatrixXf &h_diffs, Eigen::MatrixXf &h_diffs_expanded, const Eigen::MatrixXi &explored, int posex, int posey, int robot_size_cells, float trav_th, bool unknownIsObstacle);
